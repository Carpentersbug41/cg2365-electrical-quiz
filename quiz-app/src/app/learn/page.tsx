...
import lesson202_10A from '@/data/lessons/202-10A-dead-test-language-what-each-test-proves';
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-12">
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-slate-300">
              Hands-on practical skills and real-world installation scenarios
            </p>
          </div>
