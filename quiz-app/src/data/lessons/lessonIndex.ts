...
export const lessonIndex: LessonIndexEntry[] = [
  ...
  },
  {
    ...
    topic: 'Specialised Installing Equipment',
    description: '[Generated lesson]',
    questionCount: getLessonQuestionCount('203-3E1'),
    available: true,
    order: 14,
  },
  {
    ...
    topic: 'Specialised Installing Equipment',
    description: '[Generated lesson]',
    questionCount: getLessonQuestionCount('203-3E11'),
    available: true,
    order: 15,
  },
  {
    ...
    topic: 'Specialised Installing Equipment',
    description: '[Generated lesson]',
    questionCount: getLessonQuestionCount('203-3E111'),
    available: true,
    order: 16,
  },
  {
  ...
  },
  {
    ...
    topic: 'Specialised Installing Equipment',
    description: '[Generated lesson]',
    questionCount: getLessonQuestionCount('203-3E1B'),
    available: true,
    order: 19,
  },
  {
    ...
    topic: 'Specialised Installing Equipment',
    description: '[Generated lesson]',
    questionCount: getLessonQuestionCount('203-3E1C'),
    available: true,
    order: 20,
  },
  {
    ...
    topic: 'Specialised Installing Equipment',
    description: '[Generated lesson]',
    questionCount: getLessonQuestionCount('203-3E1D'),
    available: true,
    order: 21,
