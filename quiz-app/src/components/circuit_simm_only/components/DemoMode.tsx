  ...
  const getInfo = () => {
    switch (mode) {
      ...
      case AppMode.VOLTAGE:
        return {
          title: "Voltage (V)",
          desc: "Voltage is the electrical 'push'. Higher voltage aligns the electron movement more strongly in one direction. It doesn't make them faster, just more directed. When more voltage, more drift.",
          label: "Voltage Level"
        };
      case AppMode.RESISTANCE:
        return {
