...
const RealMode: React.FC<Props> = ({ onBack }) => {
  ...
  const getVisualParams = (): SimulationParams => {
    // 1. Current -> Electron Count (Density/Quantity)
    ...
    // 4. Drift Speed -> Voltage vs Resistance
    // Drift = Force (Voltage) / Opposition (Resistance)
    // This maintains the user's intuition that "Resistance slows it down"
    // AND "Voltage speeds it up".
    const drift = (voltage / Math.max(0.1, resistance)) * 2.0; 
    ...
    return {
      ...
      temperature: temp,
      voltageDrop: voltage, // Pass full voltage to visualize field
      isRealMode: true,
    };
  };
    ...
    <div className="flex flex-col h-full gap-6 p-4 max-w-6xl mx-auto w-full">
      ...
      <div className="flex flex-col xl:flex-row gap-6 flex-grow">
        ...
        <div className="flex-grow flex flex-col gap-4">
          <div className="relative rounded-lg overflow-hidden border border-slate-700 shadow-2xl bg-slate-950 min-h-[300px] flex-grow">
            <SimulationCanvas 
              params={params} 
            />
             {/* Overlay HUD */}
          ...
          <div className="grid grid-cols-3 gap-4">
             ...
             <div className="bg-slate-800/50 p-4 rounded border border-slate-700 text-center">
                ...
                <div className="text-xs text-slate-500 mt-1">Speed ∝ V / R</div>
             </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-2">
                Pressure. Controls drift speed (directionality).
              </p>
            </div>
            ...
            <div className="border-t border-slate-800 pt-4">
               ...
               <div>
                ...
                <p className="text-[10px] text-slate-500 mt-2 flex items-center gap-1">
                  <BatteryWarning size={12}/> Controls Quantity (Electrons)
                </p>
              </div>
            </div>
