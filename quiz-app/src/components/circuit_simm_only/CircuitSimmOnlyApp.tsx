...
const CircuitSimmOnlyApp: React.FC = () => {
    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-4 text-center space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl px-4">
        ...
        <button
          ...
          className="md:col-span-3 group relative flex flex-col items-start p-8 bg-gradient-to-br from-slate-900 to-slate-900 border border-slate-700 rounded-2xl hover:border-green-400 hover:from-slate-800 hover:to-slate-900 transition-all duration-300 text-left shadow-lg shadow-green-900/10"
        >
          <div className="bg-green-500/10 p-3 rounded-lg mb-4 group-hover:scale-110 transition-transform">
            <Activity className="w-6 h-6 text-green-400" />
          </div>
          <h3 className="text-xl font-bold text-white mb-2">Real Circuit Simulation</h3>
          <p className="text-slate-400 text-sm">The full sandbox. Explore Ohm&apos;s Law, Geometry, and Heating effects in a complete model.</p>
        </button>
      </div>
    </div>
  );
...
export default CircuitSimmOnlyApp;
