export function buildDynamicModulePlannerPrompt(input: {
  ...
  return [
    ...
    'Each blueprint must include 4 to 6 teach/check sections by default.',
    'Only go below 4 teach/check sections if the topic is genuinely very narrow and still supports a full chunk loop.',
    'If a lesson would need more than 6 teach/check sections, split it into another lesson instead.',
    'Each teach/check section must teach one main idea only.',
        ...
        blueprints: [
          {
            ...
            teachChecks: [
              ...
              {
                title: 'Teach/Check 3',
                objective: 'Teach the third core concept.',
              },
              {
                title: 'Teach/Check 4',
                objective: 'Teach the fourth core concept.',
              },
            ],
          },
        ],
